...
% ************************************************************************
% ERP_estimation :Estimate low-rank weighted matrix W 
%
% --- Inputs ---
...
%
% --- Output ---
% W         : The estimated low-rank weighted matrix with size of [C*T],
%             satisfies W = SF*diag(alpha)*TF'.
% alpha     : The classifier parameter (eigenvalues of W). [L, 1].
% SF         : Spatio filter matrix (eigenvectors of W). [C, L].
%             Each column of SF represents a spatio filter.
% TF         : Temporal filter matrix (eigenvectors of W). [T, L].
%             Each column of TF represents a spatio filter.
