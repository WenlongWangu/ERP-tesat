function [W, b]=Nuc_APGM(cfg, X, Y, lam, bQuiet)
% Nuc_APGM   : the accelerated proximal gradient method (APGM) solving nuclear norm regularized 
%              linear least squares problem.
%
% Optimization problem: min_{W, b} f(W, b) + g(W), 
%                       where f(W, b) = sum_i(trace(W'*X_i) + b - Y_i)^2, g(W) = 2*lambda*nuc_norm(W)
%
% Syntax:
%  [W, b]=Nuc_APGM(cfg, X, Y, lambda, bQuiet)
%
% Inputs:
